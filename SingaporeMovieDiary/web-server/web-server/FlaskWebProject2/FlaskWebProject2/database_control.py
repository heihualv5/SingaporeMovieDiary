...
def addComment(comment):
    cursor.execute("CREATE TABLE IF NOT EXISTS `sqltest`.`comment` (`id` INT NOT NULL,`user_id` INT NULL,`user_name` VARCHAR(45) NULL,`imdb_id` VARCHAR(45) NULL,`movie_name` VARCHAR(45) NULL,`lon` DOUBLE NULL,`lat` DOUBLE NULL,`rate` INT NULL,`context` VARCHAR(5000) NULL,`cinema` VARCHAR(45) NULL,`time` VARCHAR(45) NULL,PRIMARY KEY (`id`));")
